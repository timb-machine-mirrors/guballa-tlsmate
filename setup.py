...
setup(
    ...
    description='Simulate a TLS client',  # Optional
    ...
    # project.
    author='Jens Guballa',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='jens@guballa.de',  # Optional
    ...
    keywords='tls client simulator',  # Optional
    ...
    install_requires=['wheel'],  # Optional
