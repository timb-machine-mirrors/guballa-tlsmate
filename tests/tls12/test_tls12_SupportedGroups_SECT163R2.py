...
class TestCase(CipherSuiteTester):
    ...
    name = "SupportedGroups_SECT163R2"
    ...
    server_cmd = (
        ...
        "--mode www -- -cipher ALL -curves sect233k1:sect163r2:sect163k1:sect233r1:"
        "sect283k1:sect283r1:sect409k1:sect409r1:sect571k1:sect571r1:secp224r1:"
