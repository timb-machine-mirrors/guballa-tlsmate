...
def test_get_ip_endpoint_resolved():
    ...
    resolved = resolver.Resolver().get_ip_endpoint(endpoint)
...
def test_get_ip_endpoint_ipv6_preference():
    ...
    resolved = resolver.Resolver().get_ip_endpoint(endpoint, ipv6_preference=True)
