...
class TestCase(TlsSuiteTester):
    ...
    sp_out_yaml = "profile_basic_openssl3_0_0_ed25519_ed448"
    recorder_yaml = "recorder_eval_cipher_suites_openssl3_0_0_ed25519_ed488"
    ...
    def check_versions(self, versions):
        ...
        assert versions[4]["ciphers"]["server_preference"] == "C_FALSE"
